...
-Depois de criar um usuário faça a criação do banco de dados "uvv".
...
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'Referente ao menor salário admitido para um cargo.';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'Referente ao maior salário admitido para um cargo.';
...
COMMENT ON TABLE hr.regioes IS 'A Tabela regiões. Contém os números e nomes das regiões.';
COMMENT ON COLUMN hr.regioes.id_regiao IS 'Referente a chave primária da tabela regiões.';
...
COMMENT ON TABLE hr.paises IS 'Tabela com as informaçõs dos países como os nomes por exemplo.';
COMMENT ON COLUMN hr.paises.id_pais IS 'Chave primária da tabela países.';
COMMENT ON COLUMN hr.paises.nome IS 'Referente ao nome do país';
COMMENT ON COLUMN hr.paises.id_regiao IS 'Referente a chave estrangeira para a tabela de regiões.';
...
COMMENT ON TABLE hr.localizacoes IS 'Contém os endereços de diversos escritórios sobre a própria empresa.';
...
COMMENT ON COLUMN hr.localizacoes.cep IS 'CEP localizacao da empresa';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'Cidade onde encontrar a empresa';
COMMENT ON COLUMN hr.localizacoes.uf IS 'Estado onde está localizado a empresa';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'Referente a chave estrangeira para a tabela de países.';
...
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'Referente a chave primaria da tabela departamentos.';
COMMENT ON COLUMN hr.departamentos.nome IS 'Nome do departamento da tabela.';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'Referente a chave estrangeira localização do departamento.';
...
COMMENT ON COLUMN hr.empregados.email IS 'Referente ao email de contato do empregado.';
COMMENT ON COLUMN hr.empregados.telefone IS 'Referente ao telefone do empregado.';
...
COMMENT ON COLUMN hr.empregados.salario IS 'Referente ao salário mensal atual do empregado.';
COMMENT ON COLUMN hr.empregados.comissao IS 'Referente aos empregados que possuem direito a comissão.';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Referente ao supervisor dos empregados.';
...
COMMENT ON TABLE hr.gerentes IS 'Tabela referente aos gerentes';
COMMENT ON COLUMN hr.gerentes.id_gerente IS 'Chave primária da tabela.';
COMMENT ON COLUMN hr.gerentes.id_departamento IS 'Chave primária e estrangeira da tabela de gerentes.';
...
COMMENT ON TABLE hr.historico_cargos IS 'Histórico dos cargos da empresa.';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'Chave primária da tabela.';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'Referente a data_inicial do empregado naquele cargo.';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'Referente ao ultimo dia do empregado naquele cargo.';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'Chave estrangeira da tabela cargos.';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'Referente a chave estrangeira da tabela departamentos.';
