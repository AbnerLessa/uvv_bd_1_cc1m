...
-Depois temos que criar o usuário e o Banco de Dados uvv .

CREATE USER abner IDENTIFIED BY '2022'

CREATE DATABASE uvv;

GRANT ALL ON  *.* TO abner;

exit

-Agora entramos no usuário para usarmos o Banco de Dados uvv
...
ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Referente ao menor salário admitido para um cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Referente ao maior salário admitido para um cargo.';
...
ALTER TABLE regioes COMMENT 'A Tabela regiões. Contém os números e nomes das regiões.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Referente a chave primária da tabela regiões.';
...
ALTER TABLE paises COMMENT 'Tabela com as informaçõs dos países como os nomes por exemplo.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave primária da tabela países.';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Referente ao nome do país';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Referente a chave estrangeira para a tabela de regiões.';
...
ALTER TABLE localizacoes COMMENT 'Contém os endereços de diversos escritórios sobre a própria empresa.';
...
ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'CEP localizacao da empresa';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade onde encontrar a empresa';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado onde está localizado a empresa';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Referente a chave estrangeira para a tabela de países.';
...
ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'Referente a chave primaria da tabela departamentos.';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome do departamento da tabela.';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'Referente a chave estrangeira localização do departamento.';
...
ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Referente ao email de contato do empregado.';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Referente ao telefone do empregado.';
...
ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Referente ao salário mensal atual do empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Referente aos empregados que possuem direito a comissão.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'Referente ao supervisor dos empregados.';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira da tabela departamentos.';
...
ALTER TABLE gerentes COMMENT 'Tabela referente aos gerentes';

ALTER TABLE gerentes MODIFY COLUMN id_gerente INTEGER COMMENT 'Chave primária da tabela.';

ALTER TABLE gerentes MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave primária e estrangeira da tabela de gerentes.';
...
ALTER TABLE historico_cargos COMMENT 'Histórico dos cargos da empresa.';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Chave primária da tabela.';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Referente a data_inicial do empregado naquele cargo.';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Referente ao ultimo dia do empregado naquele cargo.';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira da tabela cargos.';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Referente a chave estrangeira da tabela departamentos.';
